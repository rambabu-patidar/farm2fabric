...
const Hero = (props) => {
	return (
		<div className="p-6 mb-5 bg-green-200 rounded-2xl flex flex-col justify-center items-center gap-8 min-h-[80%]">
			<h1 className="p-3 pb-10 text-teal-900 text-6xl text-center font-medium underline">
				Welcome {props.username}
			</h1>

			<div className="w-full p-9  flex flex-col items-center justify-center gap-5">
				<h3 className="font-medium text-3xl teaxt-teal-900">Your stats</h3>
			...
			<ul className="w-full flex justify-center items-center gap-8">
				<li className="text-base">
					<button
						className="text-white bg-teal-900 rounded-full p-3 text-center"
